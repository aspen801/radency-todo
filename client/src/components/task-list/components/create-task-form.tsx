...
const CreateTaskForm: React.FC<any> = ({ handleCreateTask, listId }) => {
  const form = useForm({
    defaultValues: {
      name: "",
      description: "",
  ...
  const onSubmit = (data: object) => {
    handleCreateTask({ listId, task: data });
  };

  return (
    <Form {...form}>
      <h1 className="font-bold text-[24px] text-center">Create new task</h1>
